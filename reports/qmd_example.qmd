...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){width=70% #fig-horse-pops-plot}
...
We present the standard deviations in @tbl-historical-sd.

```{python}
#| label: tbl-historical-sd
...
Additionally, note that in @tbl-historical-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops-plot.
